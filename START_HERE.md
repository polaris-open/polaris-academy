...
| **Dev who wants to build with AI** | Open the starter; run setup and tests | [starters/ai-incident-support-assistant/README.md](starters/ai-incident-support-assistant/README.md) | `make setup` → `make test` | Setup green + `progress.md` started | Treating an LLM as "just another API" and skipping evals |
